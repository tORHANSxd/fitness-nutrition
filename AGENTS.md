...
本项目需要 Git 存档。代码修改后必须提交到本地 Git，并推送到本地远端：

`D:\Workspace\git\fitness_nutrition.git`

提交信息格式：

`YYYY-MM-DD HH:mm:ss {中文修改内容}`

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **_Workspace_git_fitness_nutrition** (590 symbols, 1167 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
