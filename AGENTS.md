...
This project is indexed by GitNexus as **_Workspace_git_fitness_nutrition** (299 symbols, 567 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
